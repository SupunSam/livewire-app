      ...
      <x-jet-dialog-modal wire:model="displayingToken">
            ...
            <x-slot name="content">
                  ...
                  <x-jet-input x-ref="plaintextToken" type="text" readonly :value="$plainTextToken"
                        class="w-full px-4 py-2 mt-4 font-mono text-sm text-gray-500 bg-gray-100 rounded" autofocus autocomplete="off" autocorrect="off"
                        autocapitalize="off" spellcheck="false" @showing-token-modal.window="setTimeout(() => $refs.plaintextToken.select(), 250)" />
            </x-slot>
